...
export async function POST(req: NextRequest) {
  ...
  try {
        ...
        <div class="wrapper">
          <div class="container">
            <div class="header">
              ...
              <div class="sub-brand">
                Premium Logistics & Delivery Services
              </div>
            </div>
            ...
            <div class="content">
              ...
              <div class="closing">
                ...
                reply to this email or contact our
            ...
            <div class="footer">
              ...
              This email was sent in response to your
              enquiry.
            </div>
          </div>
        </div>
    ...
    const text = `
FirstFlyExpress - Reply to your enquiry

Dear ${name},

Thank you for contacting FirstFlyExpress.
...
If you need further assistance, kindly reply to this email.
...
All rights reserved.
    ...
    const { data, error } =
      await resend.emails.send({
        from:
          "FirstFlyExpress <support@firstflyexpres.com>",
        to: [to],
        subject:
          subject ||
          "Re: Your enquiry - FirstFlyExpress",
        html,
        text,
      });
