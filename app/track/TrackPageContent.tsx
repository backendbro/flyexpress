...
//     if (!raw) {
//       window.alert("Please enter an Airway Bill Number");
//       return;
//     }
...
//     if (!raw) {
//       window.alert("Please enter AWB number to fetch Proof of Delivery");
//       return;
//     }
//     setPodOpen(true);
//   }
...
// Force client-side rendering for Next.js
...
export function TrackPageContent() {
  ...
  function onPodSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!raw) {
      setErrorMessage("Please enter AWB number to fetch Proof of Delivery");
      return;
    }
  ...
  return (
    <>
      ...
      {/* Error display */}
      {errorMessage && (
        <div className="max-w-7xl mx-auto px-6 mt-4 text-red-500 text-sm font-medium">
          {errorMessage}
        </div>
      )}
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="track-card p-6 md:p-8">
            ...
            <form onSubmit={onPodSubmit} className="space-y-4">
              ...
              <button type="submit" className="btn-outline-track">
                <i className="fas fa-file-pdf" /> View POD
              </button>
            </form>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-center gap-5">
          <div className="flex items-center gap-4">
            <i className="fas fa-headset text-red-500 text-4xl" />
            <div>
              <h3 className="font-bold text-gray-800">Need help with tracking?</h3>
